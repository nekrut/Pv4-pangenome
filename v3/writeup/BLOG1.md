...
![Fig. 3. Subway map of PvP01 chromosome 1 in the two-way PGGB graph. Gray tube is the shared backbone, blue marks PvP01-only segments, orange dashes mark PAM gaps relative to PvP01. We show chromosome 1 only, because a whole-genome odgi 1D view is unreadable at blog scale.](graph_viz/chr1_2way_subway.png)
